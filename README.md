...
| 模式 | 说明 | 适用场景 |
| :--- | :--- | :--- |
| **`1` 🚀 极速画廊** | 高并发，无延迟，翻页快 | 普通摄影网站、建筑设计网、对爬虫限制宽松的站点 |
| **`2` 🛡️ 潜行画廊** | 单线程，长延迟 (10-20s)，翻页长休眠 | **Rule34, Gelbooru** 等反爬严格的图站 (推荐) |
| **`3` 📜 单页瀑布流**| 不翻页，自动下拉唤醒懒加载，直接抓取当前页所有图 | **微信公众号、知乎、微博长文** 等单页多图结构 |
| **`4` 🔧 手动调校** | 自定义并发数与延迟时间 | 高级用户 |
